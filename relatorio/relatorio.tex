...
melhor vazão de MFlops/s, como pode ser observar no gráfico%~\ref{flopsOtm}, que
exibe a vazão de MFlops/s para uma iteração de lambda.

%\begin{figure}[htb] \begin{center}
%\includegraphics[width=100mm]{img/flopsOtm.jpg} \end{center} \caption{MFlops/s
%com otimização e sem por dimensão de matriz}\label{fig:flopsOtm} \end{figure}
